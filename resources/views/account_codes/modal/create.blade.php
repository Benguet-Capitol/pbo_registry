...
<form id="createAccountCodeForm" method="POST" action="{{ route('account_codes.store') }}">
    @csrf
    <div id="createAccountCodeModal" tabindex="1" aria-hidden="true" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
        <div class="relative top-20 mx-auto p-4 border w-full max-w-3xl shadow-lg rounded-md bg-white dark:bg-gray-800">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex justify-between items-center p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" onclick="closeCreateAccountCodeModal()" class="text-black hover:text-gray-600 dark:text-white">
...
<script>
    function openCreateAccountCodeModal() {
        closeAllDropdowns();
        document.getElementById('createAccountCodeModal').classList.remove('hidden');
    }

    function closeCreateAccountCodeModal() {
        document.getElementById('createAccountCodeModal').classList.add('hidden');
    }
