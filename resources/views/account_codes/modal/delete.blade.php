...
<script>
    function openDeleteAccountCodeModal(userId, accountCode) {
        ...
        document.getElementById('deleteModalContent').innerHTML = `Are you sure you want to delete this Account with Account Code: <strong>${accountCode}</strong>? This action cannot be undone.`;
