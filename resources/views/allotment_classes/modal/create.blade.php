...
<form id="createAllotmentClassForm" method="POST" action="{{ route('allotment_classes.store') }}">
    @csrf
    <div id="createAllotmentClassModal" style="display: none;" tabindex="-1" aria-labelledby="createAllotmentClassLabel" aria-hidden="true" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-4xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 hidden animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
                <h3 id="createAllotmentClassLabel" class="text-base font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                    <i class="fas fa-torah text-blue-600 dark:text-blue-400"></i>
                    {{ __('Create Allotment Class') }}
                </h3>
                <button type="button" onclick="closeCreateAllotmentClassModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.input withicon id="description" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="description" autocomplete="off" :value="old('description')" autofocus placeholder="{{ __('Description') }}" />
                            </x-form.input-with-icon-wrapper>
                        ...
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.select withicon id="category" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="category" :value="old('category')" placeholder="{{ __('Category') }}">
