                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.input withicon id="edit_class" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_class" :value="old('class')" autocomplete="off" autofocus placeholder="{{ __('Class') }}" />
                            </x-form.input-with-icon-wrapper>
