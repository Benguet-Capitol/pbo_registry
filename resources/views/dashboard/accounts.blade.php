...
if (typeof originalUpdateCardValues === 'function') {
    ...
    function printObligationsModal(source = 'dashboard') {
        ...
        // Get the HTML of the cloned container (table with thead/tbody/tfoot only — no print-date inside it)
