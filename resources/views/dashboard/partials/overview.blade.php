            ...
            <div class="mb-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                        ...
                        <div id="obligationHistogram" class="h-64" data-ranges="@json($obligationRanges)"></div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                        ...
                        <div id="obligationsByQuarter" class="h-64" data-quarters="@json($obligationsByQuarter)"></div>
                    </div>
                </div>
            </div>
