...
<form id="EditDisbursementForm" method="POST" action="{{ route('disbursements.update', $disbursement->id) }}">
    @csrf
    @method('PUT')
    <div id="editDisbursementModal" tabindex="1" aria-hidden="true" class="fixed inset-0 z-50 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
        <div class="relative top-20 mx-auto p-4 border w-full max-w-5xl shadow-lg rounded-md bg-white dark:bg-gray-800">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex justify-between items-center p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" onclick="closeEditDisbursementModal()" class="text-black hover:text-gray-600 dark:text-white">
...
<script>
    ...
    // Show the modal
    document.getElementById('editDisbursementModal').classList.remove('hidden');
    // Update total footer
    updateDVAmountTotalEdit();
    }

    function closeEditDisbursementModal() {
        document.getElementById('editDisbursementModal').classList.add('hidden');
    }
