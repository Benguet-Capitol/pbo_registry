...
<form id="createFundSourceForm" method="POST" action="{{ route('fund_sources.store') }}">
    @csrf
    <div id="createFundSourceModal" tabindex="1" aria-hidden="true" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
        <div class="relative top-20 mx-auto p-4 border w-full max-w-3xl shadow-lg rounded-md bg-white dark:bg-gray-800">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex justify-between items-center p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" onclick="closeCreateFundSourceModal()" class="text-black hover:text-gray-600 dark:text-white">
...
<script>
    function openCreateFundSourceModal() {
        closeAllDropdowns();
        document.getElementById('createFundSourceModal').classList.remove('hidden');
    }

    function closeCreateFundSourceModal() {
        document.getElementById('createFundSourceModal').classList.add('hidden');
    }
