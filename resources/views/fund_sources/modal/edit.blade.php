    ...
    <div id="editFundSourceModal" style="display: none;" tabindex="-1" aria-labelledby="editFundSourceLabel" aria-hidden="true" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-4xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 hidden animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
                <h3 id="editFundSourceLabel" class="text-base font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                <div class="grid gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.select withicon id="edit_category" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_category" :value="old('category')" placeholder="{{ __('Category') }}">
                        ...
                        <!-- Source -->
                        <div class="space-y-2">
                            <x-form.label for="source" :value="__('Source')" class="block text-xs font-medium text-gray-900 dark:text-gray-200" />
                            <x-form.input-with-icon-wrapper>
                                <x-slot name="icon">
                                    <i class="fas fa-tag"></i>
                                </x-slot>
                                <x-form.input withicon id="edit_source" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_source" autocomplete="off" :value="old('source')" autofocus placeholder="{{ __('Source') }}" />
                            </x-form.input-with-icon-wrapper>
                            <span id="edit_sourceError" class="text-red-500 text-xs"></span>
                        </div>
                    </div>
                </div>
                <!-- Modal footer -->
