    ...
    <div id="editFundModal" style="display: none;" tabindex="-1" aria-labelledby="editFundLabel" aria-hidden="true" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-4xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 hidden animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
                <h3 id="editFundLabel" class="text-base font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                <div class="grid gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.input withicon id="edit_fund" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_fund" :value="old('edit_fund')" autocomplete="off" autofocus placeholder="{{ __('Fund') }}" />
                            </x-form.input-with-icon-wrapper>
                            <span id="edit_fundError" class="text-red-500 text-xs"></span>
                        </div>
                        <!-- Fund Type -->
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.select withicon id="edit_fund_type" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_fund_type" :value="old('edit_fund_type')" placeholder="{{ __('Fund Type') }}">
                            ...
                            <span id="edit_fund_typeError" class="text-red-500 text-xs"></span>
                        </div>
                        <!-- Fund Code -->
                        <div class="space-y-2">
                            ...
                            <x-form.input-with-icon-wrapper>
                                ...
                                <x-form.input withicon id="edit_fund_code" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" type="text" name="edit_fund_code" autocomplete="off" :value="old('fund_code')" autofocus placeholder="{{ __('Fund Code') }}" />
                            </x-form.input-with-icon-wrapper>
                            <span id="edit_fund_codeError" class="text-red-500 text-xs"></span>
                        </div>
                    </div>
            </div>
            <!-- Modal footer -->
