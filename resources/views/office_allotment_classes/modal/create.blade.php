...
<script>
    let isSubmittingOfficeAllotmentClass = false;
    ...
    function openCreateOfficeAllotmentClassModal() {
        closeAllDropdowns();
        isSubmittingOfficeAllotmentClass = false;
    ...
    function validateCreateOfficeAllotmentClassForm() {
        if (isSubmittingOfficeAllotmentClass) return false;
        ...
        if (isValid) {
            isSubmittingOfficeAllotmentClass = true;
