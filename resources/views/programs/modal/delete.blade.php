    ...
    <div class="relative w-full max-w-md mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 hidden animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-red-50 to-pink-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
            <h3 class="text-base font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                {{ __('Delete Program / Project / Activity') }}
            </h3>
        ...
        <!-- Modal body -->
        <div class="px-6 py-4">
            <p id="deleteModalContent" class="text-gray-900 dark:text-gray-200 text-sm">{{ __('Are you sure you want to delete this Program / Project / Activity? This action cannot be undone.') }}</p>
        </div>
        <!-- Modal footer -->
...
<script>
    function openDeleteProgramModal(userId, program) {
        ...
        document.getElementById('deleteModalContent').innerHTML = `{{ __('Are you sure you want to delete the Program / Project / Activity: ') }}<strong>${program}</strong>? {{ __('This action cannot be undone.') }}`;
