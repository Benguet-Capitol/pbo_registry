...
<form id="editRealignmentForm" method="POST" action="">
    ...
    <div id="editRealignmentModal" style="display: none;" aria-hidden="true" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-5xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
                ...
                <button type="button" onclick="closeEditRealignmentModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    ...
                    <div class="grid gap-3">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                <x-form.label for="edit_realignment_no" class="block text-xs font-medium text-gray-900 dark:text-gray-200" :value="__('Realignment No.')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-list-ol"></i>
                                        </x-slot>
                                        <x-form.input withicon type='text' name="edit_realignment_no" autocomplete="off" id="edit_realignment_no" placeholder="{{ __('Realignment No.') }}" :value="now()->format('Y-m-')" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" />
                                    </x-form.input-with-icon-wrapper>
                                    <span id="edit_realignment_noError" class="text-red-500 text-xs"></span>
                                </div>
                            </div>
                            <!-- Date -->
                            <div class="sm:col-span-3">
                                <x-form.label for="edit_realignment_date" class="block text-xs font-medium text-gray-900 dark:text-gray-200" :value="__('Date')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-calendar"></i>
                                        </x-slot>
                                        <x-form.input withicon type='date' name="edit_realignment_date" autocomplete="off" id="edit_realignment_date" placeholder="{{ __('Date') }}" :value="now()->format('Y-m-d')" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" />
                                    </x-form.input-with-icon-wrapper>
                                </div>
                            </div>
                            <!-- Basis -->
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        ...
                                        <x-form.textarea withicon type="text" name="edit_basis" autocomplete="off" id="edit_basis" placeholder="{{ __('Basis') }}" :value="old('edit_basis')" class="block w-full text-xs dark:bg-gray-800 dark:text-gray-200" />
                                    </x-form.input-with-icon-wrapper>
                            ...
                            <div class="sm:col-span-6" id="edit_source_section">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-4 mb-2">
                                    ...
                                    <div class="sm:col-span-3 relative mb-4">
                                        <x-form.label for="edit_source_office_allotment_class" class="block text-xs font-medium text-gray-900 dark:text-gray-200" :value="__('Office and Allotment Class')" />
                                        <div class="mt-2">
                                            <x-form.input-with-icon-wrapper>
                                                <x-slot name="icon">
                                            ...
                                            <span id="edit_SourceOfficeAllotmentClassError" class="text-red-500 text-xs"></span>
                                        </div>
                                    </div>
                            ...
                            <div class="sm:col-span-6" id="edit_recipient_section">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-4 mb-2">
                                    ...
                                    <div class="sm:col-span-3 relative mb-4">
                                        <x-form.label for="edit_recipient_office_allotment_class" class="block text-xs font-medium text-gray-900 dark:text-gray-200" :value="__('Office and Allotment Class')" />
                                        <div class="mt-2">
                                            <x-form.input-with-icon-wrapper>
                                                <x-slot name="icon">
                                                    <i class="fas fa-laptop-house"></i>
                                            ...
                                            <div id="edit_RecipientOfficeAllotmentClassDropdown" class="absolute w-full text-xs bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-lg hidden max-h-48 overflow-auto z-50">
                                                <!-- Suggestions appear here -->
                                            </div>
                                            <span id="edit_RecipientOfficeAllotmentClassError" class="text-red-500 text-xs"></span>
                                        </div>
                                    </div>
...
<script>
    ...
    function openEditRealignmentModal(realignment) {
        ...
        // Show the modal
        const modal = document.getElementById('editRealignmentModal');
