            ...
            <div class="overflow-x-auto overflow-y-auto max-h-[700px] border border-gray-300 dark:border-gray-600 rounded-md">
                <table id="saaodbAllFundsTable" class="w-full text-[11px] text-gray-900 dark:text-gray-300 text-left">
                    <thead class="sticky top-0 z-10 bg-gray-700 text-white dark:bg-gray-200 dark:text-gray-900">
                        <tr>
                            <th class="px-1 py-1 w-[150px] text-center" data-key="allotment_class">Allotment Class</th>
                    ...
                    <tbody class="border border-gray-300 dark:border-gray-600 text-[10px]">
                        ...
                        <tr id="summaryRow" class="sticky top-0 z-10 bg-gray-700 text-white dark:bg-gray-200 dark:text-gray-900 text-[12px] font-bold">
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-2 py-2 text-center">{{ number_format($summary['percent_obligation_vs_authorized'] ?? 0, 2) }}%</td>
                            <td class="px-2 py-2 text-right">{{ number_format($summary['total_disbursements'] ?? 0, 2) }}</td>
                            <td class="px-2 py-2 text-center">{{ number_format($summary['percent_disbursement_vs_authorized'] ?? 0, 2) }}%</td>
                            <td class="px-2 py-2 text-center">{{ number_format($summary['percent_disbursement_vs_obligation'] ?? 0, 2) }}%</td>
                        </tr>
                        @endforeach
                        ...
                        <tr class="bg-gray-800 dark:bg-gray-200 text-gray-200 dark:text-gray-700 font-bold border-t-2 border-b-2 text-[10px]">
                            ...
                            <td class="px-2 py-2 text-center">{{ number_format($grandSummary['percent_obligation_vs_authorized'] ?? 0, 2) }}%</td>
                            <td class="px-2 py-2 text-right">{{ number_format($grandSummary['total_disbursements'] ?? 0, 2) }}</td>
                            <td class="px-2 py-2 text-center">{{ number_format($grandSummary['percent_disbursement_vs_authorized'] ?? 0, 2) }}%</td>
                            <td class="px-2 py-2 text-center">{{ number_format($grandSummary['percent_disbursement_vs_obligation'] ?? 0, 2) }}%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script>
    ...
    function validateSignatories() {
        ...
        document.querySelector(`form[action="{{ route('saaodbAllFunds.exportExcel') }}"]`)
