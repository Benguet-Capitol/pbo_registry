...
<form id="editSupplementalForm" method="POST" action="">
    ...
    <div id="editSupplementalModal" style="display: none;" aria-hidden="true" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-5xl mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 animate-scaleInUp" style="animation: scaleInUp 0.3s ease-out;">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 rounded-t-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 dark:border-gray-600">
                ...
                <button type="button" onclick="closeEditSupplementalModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
...
<script>
    ...
    function openEditSupplementalModal(supplemental) {
        ...
        const modal = document.getElementById('editSupplementalModal');
