                    ...
                    <div class="grid gap-3">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                <x-form.label for="name" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Name')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-user"></i>
                                        </x-slot>
                                        <x-form.select withicon id="name" class="block w-full dark:bg-gray-800 dark:text-gray-200" type="text" name="name" :value="old('name')" placeholder="{{ __('Name') }}" onchange="updateOffice()">
                            ...
                            <!-- Username -->
                            <div class="sm:col-span-3">
                                <x-form.label for="username" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Username')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-envelope"></i>
                                        </x-slot>
                                        <x-form.input withicon id="username" class="block w-full dark:bg-gray-800 dark:text-gray-200" type="text" name="username" :value="old('username')" autocomplete="off" placeholder="{{ __('Username') }}" />
                                    </x-form.input-with-icon-wrapper>
                            ...
                            <!-- User Type / Role -->
                            <div class="sm:col-span-3">
                                <x-form.label for="usertype" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Role')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-users"></i>
                                        </x-slot>
                                        <x-form.select withicon id="usertype" class="block w-full dark:bg-gray-800 dark:text-gray-200" type="text" name="usertype" :value="old('usertype')" placeholder="{{ __('Role') }}">
                            ...
                            <!-- Office -->
                            <div class="sm:col-span-3">
                                <x-form.label for="office" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Office')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-building"></i>
                                        </x-slot>
                                        <x-form.select withicon id="office" class="block w-full dark:bg-gray-800 dark:text-gray-200" name="office" :value="old('office')" placeholder="{{ __('Office') }}">
                            ...
                            <!-- Password -->
                            <div class="sm:col-span-3">
                                <x-form.label for="password" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Password')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-lock"></i>
                                        </x-slot>
                                        <x-form.input withicon id="password" class="block w-full dark:bg-gray-800 dark:text-gray-200" type="password" name="password" autocomplete="new-password" placeholder="{{ __('Password') }}" />
                                    </x-form.input-with-icon-wrapper>
                            ...
                            <!-- Confirm Password -->
                            <div class="sm:col-span-3">
                                <x-form.label for="password_confirmation" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-200" :value="__('Confirm Password')" />
                                <div class="mt-2">
                                    <x-form.input-with-icon-wrapper>
                                        <x-slot name="icon">
                                            <i class="fas fa-lock"></i>
                                        </x-slot>
                                        <x-form.input withicon id="password_confirmation" class="block w-full dark:bg-gray-800 dark:text-gray-200" type="password" name="password_confirmation" placeholder="{{ __('Confirm Password') }}" />
                                    </x-form.input-with-icon-wrapper>
